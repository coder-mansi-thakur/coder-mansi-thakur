...
function CardContainer({ cards = [], rateChangeHandler, deleteCardHandler, editClickHandler }) {
  ...
  return (
    <div className='m-8 '>
      ...
      <Card
        ...
        view='full' id={id} rateChangeHandler={rateChangeHandler} ques={ques} createdAt={createdAt} rate={easinessFactor} />
